...
describe('<Login />', () => {
  ...
  it('calls logIn with the email and password when the form is submitted, without reloading', () => {
    const logIn = jest.fn();
    ...
    expect(logIn).toHaveBeenCalledWith('guillaume@holberton.io', 'secret');
  });
});
